...
Next, we merged the beer data with breweries data by 'Brewery_id'. We did this so we would have all of our data on one sheet. To check that we executed this step correctly we printed the first six observations and the last six observations to check the merged file.
...
To find the relationship between the bitterness of the beer and its alcoholic content we made a scatter plot and checked its correlation and we found there is .67 correlation with confidence intervals of .64 and .69 wich means the correlation is statistically significant. 
```{r}
#part 7
